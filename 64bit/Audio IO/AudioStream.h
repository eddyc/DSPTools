...
extern "C"
{
    ...
    /**
     *  Scoped destroy an AudioStream pseudoclass.

     *
     *  @param self Pointer to an AudioStream pseudoclass.

     */
    void AudioStream_scopedDelete(AudioStream **self);
    
    /**
     *  Definition used to construct a scoped AudioStream pseudoclass
     */
